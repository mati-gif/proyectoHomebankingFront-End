...
function CardActionsButtons() {
  return (
    <div className="flex space-x-2 mt-4">
      ...
      <button className="bg-gray-300 text-gray-700 font-bold py-2 px-4 rounded-[10px] hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50" type="button">
      <Link to="/cancelCard">Cancel</Link>
      </button>
    </div>
  )
}
