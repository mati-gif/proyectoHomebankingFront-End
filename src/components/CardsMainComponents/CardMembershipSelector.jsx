...
function CardMembershipSelector() {
  return (
    ...
    <select className=' bg-transparent  ml-10 p-3 w-96    border border-gray-400 rounded-[10px] w-full py-2 px-3 text-gray-700 focus:outline-none focus:border-gray-600 bg-none'  id="cardMembership" name="cardMembership">
