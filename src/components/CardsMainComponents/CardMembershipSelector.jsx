...
function CardMembershipSelector() {
  return (
    ...
    <select className=' bg-transparent  ml-10 p-3 border border-gray-400 rounded-[10px] py-2 px-3 text-gray-700 focus:outline-none focus:border-gray-600 bg-none md:w-96'  id="cardMembership" name="cardMembership">
