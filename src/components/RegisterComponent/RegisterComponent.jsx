...
function RegisterComponent() {
    return (
        <div className="relative min-h-screen bg-cover bg-center" style={{ backgroundImage: "url('https://empresas.santander.com.ar/images/background1.png')", backgroundSize: 'cover' }}>
            <div className="flex flex-col justify-center items-start absolute top-1/4 left-8 text-white">
                ...
                <h2 className="text-2xl mt-4">¡Become a member here!</h2>
                <p>-----------------------------------------</p>
            </div>
